# E1T2 — Quick-Start Buttons

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Add inline buttons for BTC/ETH/TON quick adds. Create tests/specs/E1T2.json with button interaction spec and append /start to tests/commands.json
