# E3T1 — Threshold Alert UI

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Add inline menu for setting USD price thresholds (above/below). Create tests/specs/E3T1.json and append relevant commands to tests/commands.json
