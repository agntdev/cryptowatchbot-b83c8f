# E2T1 — Inline Watchlist Add Buttons

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Create inline buttons for adding common coins. Add tests/specs/E2T1.json with button interaction spec and append relevant commands to tests/commands.json
