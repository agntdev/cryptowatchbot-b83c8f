# E7T1 — Price Polling System

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Create background job to fetch prices every minute. Implement batch requests for CoinGecko. Add tests/specs/E7T1.json for polling behavior
