# E4T1 — /price Command Implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Create /price command for symbol lookup and watchlist table. Add tests/specs/E4T1.json and append /price to tests/commands.json
