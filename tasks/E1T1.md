# E1T1 — Timezone Setup Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Create interactive flow to collect user's IANA timezone. Store in database. Add tests/specs/E1T1.json with /start command spec and append /start to tests/commands.json
