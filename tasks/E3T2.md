# E3T2 — Percent Alert UI

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Add inline menu for percent change alerts (up/down/any). Create tests/specs/E3T2.json and append relevant commands to tests/commands.json
