# E2T2 — Custom Ticker Input Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWB

Implement text input handling for custom tickers. Add CoinGecko search with top matches and confirmation. Add tests/specs/E2T2.json and append /add to tests/commands.json
